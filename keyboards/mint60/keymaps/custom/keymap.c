...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    MO(1),       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, IME_TOGGLE,   KC_UP,  MO(1),   \
    KC_ESC,    KC_LALT,    KC_LGUI,    LCTL_T(KC_LANG2),    LSFT_T(KC_SPC),        RSFT_T(KC_ENT), RCTL_T(KC_LANG1),  KC_RALT,               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
